...
<!-- Template buat ngubah suatu isi tabel -->
Kemah::find(1)->update(['title' => 'judul baru'])

<!-- Template buat ngubah suatu isi tabel v2 -->
Kemah::where{'title', 'judul'}->update(['excerpt' => 'excerpt berubah'])
